...
* *--linear*, if present, will interpolate sample data evenly throughout the entire sample.
* *--exp*, if present, will interpolate sample data exponentially (sort of) throughought the entire sample.
